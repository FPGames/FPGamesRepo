...
optionSelect_font = optionsFont;
optionSelect_itemheight = font_get_size(optionsFont);
...
audioSelect_font = optionsFont;
audioSelect_itemheight = font_get_size(optionsFont);
